...
[The colors highlighting section titles are used to indicate their current status. \hlc[green]{Green} indicates a section has been reviewed and is largely finalized. \hlc[cyan]{Blue} indicates a complete, coherent draft. \hlc[yellow]{Yellow]} indicates an incomplete draft that contains significant coherent portions. \hlc[red]{Red} indicates a mostly incomplete section consisting primarily of notes, if anything.]
