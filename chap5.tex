...
\subsection{\hlc[cyan]{SAF Results}} \label{sec:vida-saf-result}
...
\subsubsection{\hlc[yellow]{Select System Functions}}
...
\subsubsection{\hlc[cyan]{Decision-making}} \label{sec:vida-evdt-decision-method}
...
\subsection{\hlc[cyan]{EVDT Results}} \label{sec:vida-evdt-result}

\subsubsection{\hlc[cyan]{Environment}} \label{sec:vida-evdt-e-result}

\paragraph{\hlc[cyan]{Urban Nightlights}} \leavevmode\newline
...
\paragraph{\hlc[cyan]{Air Quality}} \leavevmode\newline
...
\caption[Normalization Results for PM10 in Rio de Janeiro for the Centro bairro.]{Normalization results for PM10 in the Centro bairro of Rio de Janeiro. Top: A sinusoidal correction for seasonal variation. Middle: A linear correction for secular variation. Bottom: Comparison of the corrected pre-and-post pandemic PM10 distributions.}
...
\caption[Angola COVID-19 Response Policy \& Residential Mobility Over Time]{Comparison of the Angola \ac{covid} response policy strictness and the residential mobility index over time.}
...
\subsubsection{\hlc[cyan]{Decision-Making}} \label{sec:vida-evdt-decision-results}
...
\caption[Mobility, coronavirus cases, and policy changes in Rio de Janeiro, Santiago, and Querétaro]{Comparisons of coronavirus cases, policy changes, and mobility for Rio de Janeiro, Santiago, and Querétaro.}
...
\caption[Mobility, coronavirus cases, and policy changes in Angola and Jakarta]{Comparisons of coronavirus cases, policy changes, and mobility for Angola and Jakarta.}
...
\section{\hlc[cyan]{Decision Support System}} \label{sec:vida-dss}
...
\section{\hlc[cyan]{Collaborative Development Process}} \label{sec:vida-collab}
...
Benefits and difficulties of conducting an \ac{evdt} project focusing on multiple locations like this.

The goal is not for the authors to continue development of this \ac{dss} indefinitely ourselves, but rather to hand over the \ac{dss} to local collaborators in each of the application areas, so that they can continue to adjust it to their local circumstances. Other future improvements include more automated ingestion of data from online data repositories, streamlined exporting of visualizations, and making this version accessible online.

Transition of Vida Network meetings to more general EVDT community meetings. Possibility for future webinars / courses?
