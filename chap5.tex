...
\section{\hlc[cyan]{Discussion}} \label{sec:vida-discuss}
...
\subsection{\hlc[cyan]{Methodological Limitations and Potential Improvements}}
...
\subsubsection{\hlc[cyan]{Stakeholder Collaboration and Engagement}}
...
\subsection{\hlc[cyan]{Lessons Learned for the EVDT Framework}} \label{sec:vida-lessons}

This project diverged significantly from the original concept of an \ac{evdt} project both in its speed and in its inclusion of some many distinct study areas. Such differences are useful, however, in generating lessons for the \ac{evdt} Framework.
...
\section{\hlc[cyan]{Conclusion}} \label{sec:vida-concl}
