...
\begin{center}
\scriptsize
\begin{tabular}{| C{3cm} |  L{3cm} | L{3cm} | L{3cm} |} \hline

\multicolumn{4}{|C{12cm}|}{\textbf{Contacted Stakeholders}} \\ \hline
...
\multicolumn{4}{|C{12cm}|}{Uncontacted Stakeholders} \\ \hline
...
I coded the recordings and notes qualitatively based on the \ac{saf} in order to develop meaningful themes and conclusions, identify commonalities and differences across the stakeholders, and better understand the relationships between stakeholders.
