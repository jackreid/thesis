\chapter{Western Rio de Janeiro Development \& Mangroves} \label{ch:mangroves}
...
Then, in Section \ref{sec:rio-evdt}, I turn to showing relevant datasets and analysis as applied through the \ac{evdt} models. These are also separated in methodology (Section \ref{sec:rio-evdt-method}) and results (Section \ref{sec:rio-evdt-result}). The primary flow here is understanding the state of the mangroves (health, extent, height), the ecosystem services that the mangroves provide (aquaculture, ecotourism, water quality, and carbon sequestration/storage), and how conservation and zoning policies impact the mangroves. 
...
\begin{table}[!htb]
\caption[Rio de Janeiro Stakeholder Contacts]{Rio de Janeiro Stakeholder Contacts. This table does not include casual interactions or discussions about topics unrelated to this project.}
...
\paragraph{Big Plans and Megaevents in Rio de Janeiro} \label{sec:rio-plans} \leavevmode\newline
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=1\textwidth]{Figures/chap4/Transit.png}
...
The distinguishing environmental aspect of the coastal Guaratiba area is its significant mangrove forest, made of five different mangrove species. Prior to colonization, most of the Rio de Janeiro coastal areas were either mountains or covered by mangroves. Over the centuries, the lowland mangrove forests were incrementally destroyed and filled in order to accommodate the growing city. The remaining mangrove trees of the greater Rio area, shown in Figure \ref{fig:mangrove-extent}\footnote{The methodology used to generate this and other original figures in the section are presented in Section \ref{sec:rio-evdt-e-method}.}, are confined primarily to northern portion of the Guanabara Bay (outside of the municipality) and eastern Sepetiba Bay (the bay on the western side of the city). This means that the Guaratiba forest, and the \ac{rbag} in particular, is the largest copse of mangroves within the city’s jurisdiction. These mangroves provide a variety of ecosystem services, including serving as a mechanism for highly efficient carbon sequestration, supporting a subsistence industry of fishing and crab catching (supporting vulnerable, juvenile shrimp in particular \cite{costaPensarMarPara1992}), preventing coastal erosion, and attracting a local ecotourism industry. Even these trees are under an ongoing threat.
...
\paragraph{The People of Guaratiba} \label{sec:guaratiba-people} \leavevmode\newline
...
\begin{landscape}
\begin{table}[t]
\caption[Needs, Outcomes, and Objectives for Current SETS]{Stakeholder Needs, Desired Outcomes, and potential System Objectives for key stakeholders in the existing \ac{sets}}
\label{tab:rio-sets-needs}
\begin{center}
\scriptsize
\begin{tabular}{| C{2cm} |  L{5.2cm} | L{5.2cm} | L{5.2cm} |} \hline
 
\textbf{Stakeholder Group} & \textbf{Stakeholder Needs} & \textbf{Desired Outcomes}  & \textbf{Potential \ac{sets} Objectives} \\ \hlinewd{2pt}


\multirow{3}{*}{\centering Fishers} & \tabitem{Adequate income to support a healthy and fulfilled life} & \tabitem{Access to fish and wood in their historical locations} & \tabitem{Ability to conduct sustainable wood harvesting in the mangrove forests} \\ 

 & & \tabitem{Water access for boat storage and repair} & \tabitem{Preservation/restoration of existing mangroves}  \\ 
 
 & & & \tabitem{Controls on large-scale commercial fishing activities} \\ \hline


\multirow{5}{*}{\centering \ac{smu}} & \tabitem{Fulfillment of legislative directives} & \tabitem{Improved water quality and waste removal} & \tabitem{Expanded formal sewage system} \\

& \tabitem{Economic development of the city} & \tabitem{Prevent excessive gentrification in the area} & \tabitem{Controlled drainage} \\

& \tabitem{Sufficient built infrastructure for the city} & \tabitem{Encourage economic development and increased standard of living in area}  & \tabitem{Formalization of informal settlements}\\ 

& & \tabitem{Reduced flood risk} & \tabitem{Reduced sediment accumulation in waterways} \\
...
\multirow{5}{*}{\centering \ac{smac}} & \tabitem{Fulfillment of legislative directives} & \tabitem{Conservation of environment and biodiversity in the Guaratiba area} & \tabitem{Protection of both mangroves and wetlands} \\ 

& \tabitem{Conservation of the environment and biodiversity across the city} & \tabitem{Improved water quality} & \tabitem{Replanting/restoration of mangroves across the city} \\

& & \tabitem{Improved air quality} & \tabitem{Formal sewage system}  \\

& & \tabitem{Sequestration of carbon} & \tabitem{Protection of riparian areas} \\
...
\multirow{2}{*}{\centering \ac{ipp}} & \tabitem{Fulfillment of legislative directives} & \tabitem{Ability to inform other municipal agencies} & \tabitem{Better socioenvironmental data/metrics} \\

& \tabitem{A well-informed public and well-informed municipal government agencies} & \tabitem{Understand future changes/threats} & \tabitem{Method for generating future scenarios, particularly climate change} \\ \hline
...
\begin{table}[t]
\caption[Needs, Outcomes, and Objectives for Planned DSS]{Stakeholder Needs, Desired Outcomes, and potential System Objectives for key stakeholders with regards to the planned \ac{dss}}
\label{tab:rio-dss-needs}
\begin{center}
\scriptsize
\begin{tabular}{| C{2cm} |  L{5.2cm} | L{5.2cm} | L{5.2cm} |} \hline
 
\textbf{Stakeholder Group} & \textbf{Stakeholder Needs} & \textbf{Desired Outcomes}  & \textbf{Potential \ac{dss} Objectives} \\ \hlinewd{2pt}


\multirow{2}{*}{\centering Fishers} & \tabitem{Support for wellbeing and way of life from government agencies} & \tabitem{Incorporation of local priorities and ecosystem services into government decision-making} & \tabitem{Support/justify mangrove preservation and restoration} \\ 

 & & \tabitem{Support/justify restrictions on commercial fishing and industry in the area} & \\ \hline



\multirow{5}{*}{\centering \ac{smu}} & \tabitem{Understanding of the urban planning priorities of the area} & \tabitem{Aligned priorities of the local community, private sector, and municipal government}  &  \tabitem{Support/justify zoning decisions}\\

&  & \tabitem{Reduced flooding} &  \tabitem{Inform sewage system project prioritization}\\

&  &  & \tabitem{Improve understanding of ecotourism in region}\\ \hline




\multirow{5}{*}{\centering \ac{smac}} & \tabitem{Understanding of the current state of the environment and future trends} & \tabitem{Improved monitoring capabilities} & \tabitem{Inform definition of conservation unit boundaries} \\ 

& \tabitem{Support for environment conservation from other stakeholders} &  \tabitem{Consensus on environmental priorities with other stakeholders} & \tabitem{Support/justify mangrove preservation and restoration} \\

&  &  & \tabitem{Inform targeting of new parks or replanting projects} \\

&  &  & \tabitem{\ac{eo} data use capacity building} \\

&  & \tabitem{Better use of \ac{eo} data} & \\ \hline




\multirow{2}{*}{\centering\ac{ipp}} & \tabitem{Fulfill the data needs of the public and other municipal agencies} & \tabitem{The ability to answer questions from other stakeholders} & \tabitem{Complex systems capacity building} \\

& & & \tabitem{Scenario planning capacity building} \\ \hline

\multirow{2}{*}{\centering Space Enabled} & \tabitem{Demonstrate and improve the \ac{evdt} Framework} & \tabitem{A complete \ac{evdt} project, including a produced \ac{dss} and satisfied stakeholders} & \tabitem{A \ac{dss} and development process that satisfies the broader \ac{evdt} requirements} \\

& & \tabitem{Lessons to improve the \ac{evdt} Framework} &  \tabitem{Modularity and re-usability} \\
& & \tabitem{Re-usable assets and experience for future projects} & \\ \hline
...
The Environment Model of this case study is primarily interested in the the size (as measured by geographic extent) and health of tje mangrove forest over time. Secondarily it is interested in the carbon stock and annual carbon export potential that they represent. Each of these are dependent of a variety of sources of data measuring and mapping mangroves.
...
Of these numerous sources of data and derived information, I used a subset to assess the Guaratiba region mangroves from the year 2000 to 2018. These data sources, along with what purpose they were put are summarized in Table \ref{tab:rio-environment-sources}.
...
The primary areas of new mangroves in Guaratiba proper (shown in blue on the right of Figure \ref{fig:extent-changes}) are along the interior gaps in the forests. This areas are apicum and, as explained in Section \ref{sec:guaratiba-environment}, are a natural part of the mangrove forest ecosystem. The mangroves commonly encircle these areas and generate soil in them prior to the trees themselves sprouting along their edges. The primary areas of lost extent (shown in red) occur along the human-forest interface and, to a less extent, along the water ways of the biological reserve. In the northwest corner of the right image (between Pedra de Guaratiba and Sepetiba) can be seen new growth in smaller protected areas immediately adjacent to built-up land.
...
\begin{tabular}{ C{3cm}   L{2cm}  L{2cm} L{2cm}  L{2cm} } \hline
 ...
 &  & \multicolumn{3}{C{9cm}}{\textbf{Landsat-only Classification}} \\

 &  & \textbf{Mangroves} & \textbf{Not Mangroves} & \textbf{Total} \\ \hline

\multirow{3}{*}{\textbf{Municipal LCLU}} & \textbf{Mangroves} & 2399 & 677 & 3076 \\
...
\begin{table}[H]\centering
	...
	% \small
	\fontsize{8}{10}\selectfont
	\csvreader[tabular=|C{1.5cm}|L{3cm}|L{3.5cm}|C{1.75cm}|L{2.5cm}|, 
		table head=\hline 
...
It was only through discussions with all of these stakeholders (and quite a few others) and mapping of their relationships, needs, and desires, that this project took the form it did. The fishing community were well aware of the value of the local ecosystem services but lacked a way to express it to city planners and politicians. \ac{smu} did not request information on such ecosystem services because it was not on their radar at all. Once the topic was raised with them and initial prototypes shown, however, they became more interested in incorporating such valuations into their economic analyses. 
